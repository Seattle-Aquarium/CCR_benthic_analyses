...
```{r}
# ROV pc
rov_pc <- read.csv("../results/ROV/percent_cover/HSIL_percent-cover_transect-averaged.csv")
...
dd <- read.csv("../results/ROV/percent_cover/HSIL_points_photo-level.csv")
...
# NOTE (updated 2026-07-30): HSIL_abundances_averaged.csv no longer exists --
# superseded by ../results/ROV/abundance/HSIL_viame_abundance_corrected_summed.csv
# (see build_HSIL_viame_abundance_corrected.R), which uses the same join keys
# (site, transect, season, depth) but a different/fuller set of species
# columns (full descriptive names, ground-truth-corrected transect
# assignment). Left pointed at the old filename rather than silently
# swapping in the new one, since that would change this model's input data
# without review.
